...
use crate::models::model_utils::{
    Dropout, HiddenAct, HiddenActLayer, LayerNorm, Linear, PositionEmbeddingType,
};
use crate::models::modelling_outputs::{
...
impl XLMRobertaForSequenceClassification {
    ...
    pub fn forward(
        ...
        let outputs = self.xlmroberta.forward(input_ids, token_type_ids)?;
